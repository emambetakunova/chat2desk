...
(function(d) {
    d.flexslider = function(g, l) {
        ...
        c = {
            ...
            directionNav: {
                setup: function() {
                    var b = d('<ul class="' + e + 'direction-nav"><li><a class="' + e + 'prev" href="#"><i class="fa fa-chevron-left"></i>' + a.vars.prevText + '</a></li><li><a class="' + e + 'next" href="#"><i class="fa fa-chevron-right"></i>' + a.vars.nextText + "</a></li></ul>");
        ...
        a.update = function(b, d) {
            ...
            if ("remove" === d && !h || a.pagingCount < a.controlNav.length) h && a.currentSlide > a.last && (a.currentSlide -= 1, a.animatingTo -= 1), c.controlNav.update("remove", a.last);
            a.vars.directionNav && c.directionNav.update()
        };
